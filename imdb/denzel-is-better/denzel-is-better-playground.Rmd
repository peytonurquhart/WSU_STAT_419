...
x = plotGenresAvgDf(adf, "Will Smith Avg. Box Office by Genre", "Genre", "(Millions)", ymax=400)
x;

y = plotGenresAvgDf(bdf, "Denzel Washington Avg. Box Office by Genre", "Genre", "(Millions)", ymax=400)
y;
